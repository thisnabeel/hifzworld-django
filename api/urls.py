...
from accounts.views import CreateUserView, SignInView, UpdateUserView, SearchUserByEmailView, FindUserByIdView
...
urlpatterns = [
    ...
    path('users/<int:user_id>', FindUserByIdView.as_view(), name='show_user_page'),
